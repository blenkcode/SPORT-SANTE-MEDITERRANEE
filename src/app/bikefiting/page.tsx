    ...
    <div className=" h-auto min-h-lvh w-full flex flex-col font-Straw">
      ...
      <div className="w-full  bg-slate-50 flex flex-col items-center justify-center lg:py-20 py-10">
        ...
        <div className="flex flex-col items-center justify-center lg:mt-24 mt-16">
          <h2 className="xl:text-4xl text-violet-900 lg:text-2xl text-3xl mt-10 font-bold w-fit bg-slate-50 py-2 px-5 mb-20 rounded-full">
            Notre processus
          </h2>
          <div className="w-full h-1  bg-sky-900 absolute"></div>
          <div className="flex lg:flex-row flex-col items-center justify-around w-full space-y-10 lg:space-y-0 lg:space-x-32 text-sky-900">
            {/* Section 1: Analyse de la Posture et des Mouvements */}
            <div className="flex flex-col items-center justify-center w-full lg:w-1/3">
              <h4 className="text-2xl mb-4">Analyse de la Posture</h4>
            ...
            <div className="flex flex-col items-center justify-center w-full lg:w-1/3">
              <h4 className="text-2xl mb-4">Ajustement du Vélo</h4>
              <div className="w-72 rounded-full h-72 overflow-hidden relative">
                <div className="bg-violet-700 bg-opacity-30 absolute w-full h-full"></div>
                <img
                  src="/ajust.webp"
            ...
            <div className="flex flex-col items-center justify-center w-full lg:w-1/3">
              <h4 className="text-2xl mb-4">Conseils Personnalisés</h4>
        ...
        <div className="flex lg:flex-row-reverse flex-col lg:items-start items-center justify-center lg:mt-40 mt-5 mb-20">
          <img
            src="bike2.png"
            className="lg:w-100 w-60 rounded-tl-3xl rounded-br-3xl lg:mr-20 mt-20 lg:mt-0 grayscale
          "
          ></img>
