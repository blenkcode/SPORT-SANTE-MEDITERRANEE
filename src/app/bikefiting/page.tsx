...
const bikefiting = () => {
  return (
    <div className="lg:h-lvh h-auto min-h-lvh w-full flex flex-col">
      {" "}
      <div className="bg-[url('/bike.jpg')] bg-center lg:bg-fixed bg-scroll w-full bg-cover lg:h-3/5 h-lvh text-sky-50 ">
        <div className="w-full h-full items-center justify-center font-Straw flex flex-col bg-gradient-to-r from-purple-800/40  to-purple-800/0">
