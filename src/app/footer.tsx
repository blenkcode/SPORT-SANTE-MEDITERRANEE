...
const footer = () => {
  return (
    <div className="w-full h-fit py-10 px-10 bg-sky-900 flex items-center lg:flex-row flex-col justify-center font-Straw">
      ...
      <div className="w-full flex-end mt-10 lg:mt-0 ">
