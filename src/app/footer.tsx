  ...
  return (
    <div className="w-full h-fit py-20 px-10 bg-sky-900 flex items-center justify-center">
      <div className="flex lg:flex-row flex-col justify-center items-center ">
        <ul className="text-lg lg:text-xl w-full ">
        ...
        <ul className="text-lg lg:text-xl w-full flex items-center flex-col mt-10 lg:mt-0 ">
          <li>Sport - Santé Méditerranée 2024</li>
          <li className="flex items-center">
            <img src="/logomain.png" className="w-20 mt-10 rounded-full"></img>
          </li>
          <li className="mt-10">
            {" "}
            WebSite by{" "}
        ...
        <div className="container mx-auto text-center mt-10 lg:mt-0 lg:ml-24">
