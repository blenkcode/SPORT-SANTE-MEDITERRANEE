...
const footer = () => {
  return (
    <div className="w-full h-fit py-10 px-10 bg-sky-950 flex items-center lg:flex-row flex-col justify-center font-Straw">
      ...
      <div className="lg:w-1/5 h-full mr-10">
      ...
      <div className="lg:w-1/5 h-full mt-10 lg:mt-0">
        <iframe
