...
const kinesitherapie = () => {
  return (
    <div className="lg:h-lvh h-auto min-h-lvh w-full flex flex-col">
      {" "}
      <div className="bg-[url('/kine.png')] bg-center lg:bg-fixed bg-scroll w-full bg-cover lg:h-3/5 h-lvh text-sky-50 ">
        <div className="w-full h-full items-center justify-center font-Straw flex flex-col bg-gradient-to-r from-orange-800/40 to-orange-500/0">
